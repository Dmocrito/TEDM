% Adapted version from SPM


function [SPM] = tedm_fMRI_design(SPM);
...
%- Construct Enhancd Design Matrix
%==========================================================================
...
for s = 1:length(SPM.nscan)
    ...
    %-Set Enhanced Design matrix and names fo the Regressors
...
%-Save TEDM SPM.mat
name = SPM.TEDM.hist.outfile;

save(name, 'SPM', spm_get_defaults('mat.format'));